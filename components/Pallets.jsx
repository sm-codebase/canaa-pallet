...
function Pallets() {
  ...
  return (
    <div id="pallets">
      <div className="max-w-full h-[400px] md:h-[700px] w-full m-auto ">
      ...
      <div className="p-10 font-medium text-base text-gray-600 leading-8 line-clamp-3 ">
        <p className="">
          A Canna Pallets é uma empresa reconhecida por fornecer uma ampla
          variedade de soluções de pallets adequadas para atender às demandas de
          diversos setores, tanto no mercado doméstico quanto nas exportações.
          Nosso compromisso com a excelência e a inovação nos torna uma escolha
          confiável para uma ampla gama de indústrias, incluindo automotiva,
          alimentícia, papelaria, farmacêutica, química, petroquímica,
          eletroeletrônica, bens de consumo e outros. Para cada um desses
          setores, a Canna Pallets desenvolveu pallets específicos que atendem
          aos mais altos padrões de qualidade e segurança.
        </p>{" "}
        <p>
          Nossos pallets são projetados para garantir a integridade dos produtos
        ...
        <p>
          {" "}
          No segmento automotivo, por exemplo, a Canna Pallets oferece soluções
          robustas e duráveis para proteger peças e componentes, garantindo que
          cheguem ao destino final em condições ideais. No setor alimentício,
          nossos pallets são desenvolvidos com materiais seguros e higiênicos
          para preservar a qualidade dos alimentos. Da mesma forma, no mercado
          farmacêutico, dedicamos esforços para criar pallets que atendam aos
          mais rigorosos padrões de segurança e regulamentação.
        </p>
      </div>
    </div>
  );
